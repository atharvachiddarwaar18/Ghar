...
const SEED_PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Meticulously crafted by artisans, this heavy vase features hundreds of natural stones inlaid in a geometric mosaic pattern. The earthy, organic texture pairs beautifully with dried pampas grass or vibrant fresh blooms.',
  ...
  },
  {
    ...
    description: 'Inspired by royal palaces, this grand pendant lamp features cascading layers of delicate crystal tassels suspended from a burnished brass frame.',
  ...
  },
  {
    ...
    description: 'A magnificent crown-shaped chandelier accented with rare turquoise crystals set among clear diamond-cut stones.',
...
export async function POST(request) {
  ...
  try {
    ...
    return NextResponse.json({ error: 'Seed failed', details: err.message }, { status: 500 })
  }
}
