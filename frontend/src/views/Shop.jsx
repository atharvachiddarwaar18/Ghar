          ...
          <div className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              <div className="text-center py-24">
                ...
                <button onClick={() => { router.push('?'); setSearchQuery('') }} className="btn-primary">
                  Clear Filters
                </button>
              </div>
            )}
...
const Shop = (props) => (
  <React.Suspense fallback={<div className="min-h-screen bg-cream pt-20 flex items-center justify-center">Loading...</div>}>
    <ShopInner {...props} />
  </React.Suspense>
)
