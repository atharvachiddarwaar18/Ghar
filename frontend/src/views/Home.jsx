    ...
    <main>
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Link href="/about" className="btn-gold inline-flex items-center gap-2 group">
            Read Our Story
      ...
      <section className="py-20 bg-cream" aria-label="Wall decor collection">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12">
            ...
            <Link href="/shop?category=Wall+Decor" className="btn-secondary mt-6 sm:mt-0 self-start sm:self-auto">
              View All Wall Decor
            </Link>
          </div>
      ...
      <section className="py-20 bg-softgray" aria-label="Designer vases">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/shop?category=Vases" className="btn-primary">
              Shop All Vases
            </Link>
          </div>
        </div>
